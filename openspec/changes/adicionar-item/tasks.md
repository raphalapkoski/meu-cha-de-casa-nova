...
- [ ] 1.1 Criar `shared-types/src/lib/item.ts` com interface `IItem` e tipo `CreateItemDto`
- [ ] 1.2 Exportar os novos tipos em `shared-types/src/index.ts`
- [ ] 1.3 Verificar build do shared-types (`npm exec nx build shared-types`)
